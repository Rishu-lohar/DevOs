...
// Minimal SVG icons for Google and Microsoft / GitHub
function GoogleIcon() {
  return (
...
export default function LoginPage() {
  return (
    <div className="space-y-6">
      ...
      {/* Primary Continue Buttons matching the screenshot exactly */}
      ...
      <div>
        <button
          type="button"
          className="text-xs text-slate-500 hover:text-slate-300 transition-colors underline decoration-slate-600 underline-offset-4"
        >
      ...
      <p className="text-center text-xs text-slate-500">
        New to DevOS?{" "}
        <Link className="font-medium text-violet-400 hover:text-violet-300 transition-colors" href="/signup">
          Create an account
        </Link>
      </p>
    </div>
