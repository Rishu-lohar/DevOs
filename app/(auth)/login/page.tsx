    ...
    <div data-testid="login-page" className="space-y-6">
      <div>
        ...
        <p className="mt-2.5 text-sm leading-relaxed text-[#71717A]">
          Transcribe, summarize, search, and analyze all your engineering conversations and projects.
        </p>
      </div>
      ...
      <div className="space-y-2.5">
        <button
          type="button"
          data-testid="continue-google-button"
        ...
        <button
          type="button"
          data-testid="continue-outlook-button"
          className="group relative flex h-11 w-full items-center justify-between rounded-[12px] border border-[#232326] bg-[#111113] px-4 text-xs font-medium text-[#FAFAFA] transition-colors duration-150 hover:border-[#3F3F46] hover:bg-[#18181B] sm:text-sm"
        >
          <div className="flex items-center gap-3">
            <MicrosoftIcon />
            <span>Continue with Outlook Calendar</span>
          </div>
          <ArrowRight
            size={14}
            className="text-[#71717A] transition-transform duration-150 group-hover:translate-x-0.5 group-hover:text-[#FAFAFA]"
      ...
      <button
        type="button"
        data-testid="why-calendar-button"
        className="text-[11px] text-[#71717A] underline decoration-[#232326] underline-offset-4 transition-colors duration-150 hover:text-[#A1A1AA]"
      >
        Why does DevOS require access to my calendar?
      </button>
      ...
      <div className="space-y-4">
        <Input
          ...
          type="email"
          defaultValue="rishu@devos.ai"
        />
        <div>
          <div className="mb-1.5 flex justify-between text-xs">
            <label className="text-[#71717A]">Password</label>
            <button
              type="button"
              data-testid="forgot-password-link"
              className="text-[#C4B5FD] transition-colors duration-150 hover:text-white"
            >
              Forgot password?
            </button>
          </div>
